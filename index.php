...
<html>
<head>
<title>Launch Page: Scrapyard Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="scrapyardForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level2" class="dropdownmenu2Iconic">
				<option value="01" selected>Scrapyard, Level 1</option>
				<option value="02">Scrapyard, Level 2</option>
				<option value="03">Scrapyard, Level 3</option>
				<option value="04">Scrapyard, Level 4</option>
				<option value="05">Scrapyard, Level 5</option>
				<option value="06">Scrapyard, Level 6</option>
				<option value="07">Scrapyard, Level 7</option>
				<option value="08">Scrapyard, Level 8</option>
				<option value="09">Scrapyard, Level 9</option>
				<option value="10">Scrapyard, Level 10</option>
			  </select>
        ...
        {
            $("#scrapyardForm").attr('action', "scrapyard/scrapyard"+ $("#level2").val() +  ".php");
        });
